...
REM
REM Generated by Vivado on Tue Aug 12 12:55:55 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_axis_regslice_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_axis_regslice_vlog.prj -log xvlog.log
