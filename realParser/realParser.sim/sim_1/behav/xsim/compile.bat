...
REM
REM Generated by Vivado on Sun Jul 20 16:34:58 -0400 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_parser_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_parser_vlog.prj -log xvlog.log
